...
Above is the file you will read in, Download it to your PC  ("Random.txt") and place in the 
same folder as your C++ file for this assignment.  Write a program that reads all the number 
in the "Random.txt" file and calculates the following:
...
int main() 
{
	...
	cout << "A.) The number of numbers in the file is: "<< count << endl;
